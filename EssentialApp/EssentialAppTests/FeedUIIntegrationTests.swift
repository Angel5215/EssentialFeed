...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadingMoreIndicator_isVisibleWhileLoadingMore() {
        ...
        loader.completeLoadMoreWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no loading indicator once user initiated laoding completes with error")
    }
    ...
    func test_feedImageView_doesNotLoadImageAgainUntilPreviousRequestCompletes() {
        ...
        sut.simulateFeedImageViewNearVisible(at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [image.url], "Expected first request")
    ...
    // MARK: - Feed Image View Retry Button
    ...
    // MARK: - Feed Image View Retry Action
    ...
    // MARK: - Load Image Data Completion
